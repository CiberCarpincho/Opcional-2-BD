...
(Name VARCHAR(50) NOT NULL UNIQUE,
 ...
 Capital VARCHAR(50),
 Province VARCHAR(50),
 Area DECIMAL CONSTRAINT CountryArea CHECK (Area >= 0),
 Population DECIMAL CONSTRAINT CountryPop CHECK (Population >= 0));

CREATE TABLE City
(Name VARCHAR(50),
 Country VARCHAR(4),
 Province VARCHAR(50),
 Population DECIMAL CONSTRAINT CityPop CHECK (Population >= 0),
 Latitude DECIMAL CONSTRAINT CityLat CHECK ((Latitude >= -90) AND (Latitude <= 90)),
 Longitude DECIMAL CONSTRAINT CityLon CHECK ((Longitude >= -180) AND (Longitude <= 180)),
 Elevation DECIMAL,
...
(Name VARCHAR(50) CONSTRAINT PrName NOT NULL,
 ...
 Population DECIMAL CONSTRAINT PrPop CHECK (Population >= 0),
 Area DECIMAL CONSTRAINT PrAr CHECK (Area >= 0),
 Capital VARCHAR(50),
 CapProv VARCHAR(50),
...
(Country VARCHAR(4) CONSTRAINT EconomyKey PRIMARY KEY,
 GDP DECIMAL CONSTRAINT EconomyGDP CHECK (GDP >= 0),
 Agriculture DECIMAL,
 Service DECIMAL,
 Industry DECIMAL,
 Inflation DECIMAL,
...
(Country VARCHAR(4),
 Name VARCHAR(50),
 Percentage DECIMAL CONSTRAINT ReligionPercent CHECK ((Percentage > 0) AND (Percentage <= 100)),
 CONSTRAINT ReligionKey PRIMARY KEY (Name, Country));

CREATE TABLE EthnicGroup
(Country VARCHAR(4),
 Name VARCHAR(50),
 Percentage DECIMAL CONSTRAINT EthnicPercent CHECK ((Percentage > 0) AND (Percentage <= 100)),
 CONSTRAINT EthnicKey PRIMARY KEY (Name, Country));

CREATE TABLE Language
(Country VARCHAR(4),
 Name VARCHAR(50),
 Percentage DECIMAL CONSTRAINT LanguagePercent CHECK ((Percentage > 0) AND (Percentage <= 100)),
...
(Country VARCHAR(4),
 Year DECIMAL CONSTRAINT CountryPopsYear CHECK (Year >= 0),
     Population DECIMAL CONSTRAINT CountryPopsPop CHECK (Population >= 0),
...
(Province VARCHAR(50),
 Country VARCHAR(4),
 Year DECIMAL CONSTRAINT ProvPopsYear CHECK (Year >= 0),
     Population DECIMAL CONSTRAINT ProvPopsPop CHECK (Population >= 0),
...
(City VARCHAR(50),
 Country VARCHAR(4),
 Province VARCHAR(50),
 Year DECIMAL CONSTRAINT CityPopsYear CHECK (Year >= 0),
     Population DECIMAL CONSTRAINT CityPopsPop CHECK (Population >= 0),
...
(Name VARCHAR(50) CONSTRAINT RiverKey PRIMARY KEY,
 ...
 Lake VARCHAR(50),
 Sea VARCHAR(50),
 Length DECIMAL CONSTRAINT RiverLength CHECK (Length >= 0),
 Area DECIMAL CONSTRAINT RiverArea CHECK (Area >= 0),
 Source GeoCoord CONSTRAINT SourceCoord
     ...
     CONSTRAINT RivFlowsInto
         CHECK ((River IS NULL AND Lake IS NULL) OR
                (River IS NULL AND Sea IS NULL) OR
                (Lake IS NULL AND Sea IS NULL)));
...
(IATACode VARCHAR(3) PRIMARY KEY,
 ...
 Province VARCHAR(50),
 Island VARCHAR(50),
 Latitude DECIMAL CONSTRAINT AirpLat CHECK ((Latitude >= -90) AND (Latitude <= 90)),
 Longitude DECIMAL CONSTRAINT AirpLon CHECK ((Longitude >= -180) AND (Longitude <= 180)),
 Elevation DECIMAL,
 gmtOffset DECIMAL);